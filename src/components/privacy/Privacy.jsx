    ...
    render() {
     ...
     <div className='wrapperPrivacy'>
                ...
                <div className='textWrapper'>
                    ...
                    <p className='mainArticle'>
                        Vi har laget en fullstendig /* <a href="icebreaker.no/cookies">(KORRIGER LINK) liste over alle Informasjonskapsler som
                        finnes på icebreaker.no</a> På <a href="nettvett.no">nettvett.no</a> kan du lese om hvordan du
                        <a href="https://nettvett.no/slik-administrer-du-informasjonskapsler/">stiller inn nettleseren for å godta/avvise
                    ...
                    <p className='mainArticle'>
                        ...
                        tidspunkt, <a href="https://no.wikipedia.org/wiki/Uniform_Resource_Locator">nettadresse</a>, 
                        <a href="https://no.wikipedia.org/wiki/Liste_over_HTTP-statuskoder">HTTP-status</a>, antall bytes sendt, 
                        <a href="https://en.wikipedia.org/wiki/HTTP_referer">HTTP referer</a> og <a href="https://en.wikipedia.org/wiki/User_agent">HTTP user agent</a> 
                        blir logget i 15 dager. Deretter blir loggen slettet automatisk.
                    </p>
