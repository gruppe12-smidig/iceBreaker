        ...
        return(
            <div className='mainContainer'>
                ...
                <div className='textWrapper'>
                    ...
                    kan føre til at Icebreakers nettjenester ikke vil fungere optimalt.

                    <a href="https://nettvett.no/slik-administrer-du-informasjonskapsler/">Nettsiden nettvett.no 
                    forklarer hvordan du selv kan administrere informasjonskapsler.</a>
                    </p>

                    <h4 className='miniHeadline'>Hvordan varsle brukere om cookies?</h4>
                    
                    <p className='mainArticle'>
                    I tillegg til personvernforordningen er det 
                    <a href="https://lovdata.no/dokument/NL/lov/2003-07-04-83/KAPITTEL_2#%C2%A72-7b">ekomloven § 2-7 b</a>,
                    den såkalte "cookie paragrafen", som regulerer vilkårene for lagring av opplysninger i kommunikasjonsutstyr.
